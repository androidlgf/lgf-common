...
import com.cn.lgf.common.aspect.permission.permissiondispatcher.CheckPermission;
import com.cn.lgf.common.aspect.permission.permissiondispatcher.PermissionItem;
import com.cn.lgf.common.aspect.permission.permissiondispatcher.PermissionListener;

import com.cn.lgf.common.utils.ContextUtils;
...
public class CheckPermissionAspect {
    ...
    @Pointcut("execution(@com.cn.lgf.common.aspect.permission.annotations.NeedPermission * *(..)) && @annotation(needPermission)")
    ...
    @Pointcut("execution(* android.app.Activity.onCreate(..)) && !within(android.support.v7.app.AppCompatActivity)" +
            ...
            " && !within(com.cn.lgf.common.aspect.permission.permissiondispatcher.ShadowPermissionActivity)")
